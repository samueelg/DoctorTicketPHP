        ...
        <div class="col-md-6">
            <div class="card shadow-sm">
                <div class="card-header text-center">
                    <h5 class="mb-0">Edição de Usuário</h5>
                </div>
                <div class="card-body">
                    <form action="{{ route('editUserSubmit', $user) }}" method="POST">
                        @csrf
                        <div class="mb-2">
                            <label>Tipo:</label>
                            ...
                            <div class="form-check">
                                @if($user->tipo == 'admin')
                                    <input class="form-check-input" type="radio" value="admin" name="tipo" id="adm" checked>
                                @else
